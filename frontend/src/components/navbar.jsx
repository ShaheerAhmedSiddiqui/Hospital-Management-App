...
const ROLE_COLOR = { admin: 'bg-purple-600', doctor: 'bg-teal-600', patient: 'bg-blue-600' };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <div className={`w-8 h-8 ${ROLE_COLOR[user?.role]} rounded-lg flex items-center justify-center`}>
